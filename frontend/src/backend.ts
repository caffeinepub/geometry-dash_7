...
import type { CommunityLevel as _CommunityLevel, PlayerProfile as _PlayerProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCommunityLevels(): Promise<Array<CommunityLevel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCommunityLevels();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllLevels(): Promise<Array<CommunityLevel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLevels();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCommunityLevel(arg0: bigint): Promise<CommunityLevel | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCommunityLevel(arg0);
    ...
    async getLeaderboardEntries(arg0: bigint): Promise<Array<LeaderboardEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLeaderboardEntries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopRatedLevels(arg0: bigint): Promise<Array<CommunityLevel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopRatedLevels(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async publishLevel(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.publishLevel(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rateLevel(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rateLevel(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CommunityLevel]): CommunityLevel | null {
    return value.length === 0 ? null : value[0];
}
